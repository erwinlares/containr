...
analyzes a project’s environment and dependencies via `renv.lock` and
generates a ready-to-use `Dockerfile` — so analyses can be reliably
shared, archived, and rerun across systems.
