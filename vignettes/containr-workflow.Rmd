...
locally becomes `/home/data-raw/sample.csv` in the container. All files must
be inside the current working directory (the build context). Each argument
accepts a single path, a character vector of paths, or a path to a
